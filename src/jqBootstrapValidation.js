(function ($) {
        ...
        methods: {
            init: function (options) {
                ...
                $(uniqueForms).bind("submit.validationSubmit", function (e) {
                    ...
                    var $allControlGroups = $form.find(".");
            ...
            destroy: function () {
                ...
                return this.each(
                    function () {
                        ...
                        var
                            $this = $(this),
                            $controlGroup = $this.parents(".").first(),
                            $helpBlock = $controlGroup.find(".help-block").first(),
                            $form = $this.parents("form").first();
            ...
            match: {
                ...
                init: function ($this, name) {
                    ...
                    if (($label = $form.find("label[for=\"" + elementName + "\"]")).length) {
                        message += " '" + $label.text() + "'";
                    } else if (($label = $element.parents(".").first().find("label")).length) {
    ...
    var getValue = function ($this) {
        ...
        if (type === "checkbox") {
            ...
            var checkboxParent = $this.parents("form").first() || $this.parents(".").first();
            if (checkboxParent) {
            ...
            var radioParent = $this.parents("form").first() || $this.parents(".").first();
            if (radioParent) {
